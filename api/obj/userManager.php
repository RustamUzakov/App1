...
/////////////////////PUBLIC METHODS //////////////////////////////////
	...
	public function pullHourlyRecord( $tM,$tT,$tW,$tTh,$tF,$tS,$tSun,$tWeek ){
	

	$newRecordID = $this->dbCon->insertRecord( "user_hours_record",
		 								array("userID","totalMonday","totalTuesday","totalWednesday","totalThursday","totalFriday","totalSaturday","totalSunday","totalWeek"),
		 								array( 	$_SESSION[ 'userID' ],$tM,$tT,$tW,$tTh,$tF,$tS,$tSun,$tWeek )
		 								);
		// 	//initiate session
	...
	public function deleteRecord($id ){
			...
			$newRecordID = $this->dbCon->deleteRecord( $id);

		//$result['status'] 	= "success";
		$result['test'] 	=$newRecordID;
		/*$result['test'] 	= $tM;*/
